...
async fn start_internal() {
   let shader = wgpu::include_spirv_raw!("../crates/build-shaders/target/spirv-builder/spirv-unknown-vulkan1.2/release/deps/compute_shader.spv");
...
pub fn apply(_lut: &lut::Cube3D, _src: &RgbImage, _dst: &mut RgbImage) {
